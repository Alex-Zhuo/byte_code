...
public class ConstantPoolFactory {
  ...
  public ConstantPoolInfo getCp(DataInputStream in) throws IOException {
    int tag = ClassReader.readUnsignedByte(in);
    ConstantPoolInfo cp;
    switch (tag) {
      case CONSTANT_UTF8:
        cp = new ConstantUtf8Info(in);
        break;
      case CONSTANT_INTEGER:
        cp = new ConstantIntegerInfo(in);
        break;
      case CONSTANT_FLOAT:
        cp = new ConstantFloatInfo(in);
        break;
      case CONSTANT_LONG:
        cp = new ConstantLongInfo(in);
        break;
      case CONSTANT_DOUBLE:
        cp = new ConstantDoubleInfo(in);
        break;
      case CONSTANT_CLASS:
        cp = new ConstantClassInfo(in);
        break;
      case CONSTANT_STRING:
        cp = new ConstantStringInfo(in);
        break;
      case CONSTANT_FIELD_REF:
        cp = new ConstantFieldRefInfo(in);
        break;
      case CONSTANT_METHOD_REF:
        cp = new ConstantMethodRefInfo(in);
        break;
      case CONSTANT_INTERFACE_METHOD_REF:
        cp = new ConstantInterfaceMethodRefInfo(in);
        break;
      case CONSTANT_NAME_AND_TYPE:
        cp = new ConstantNameAndTypeInfo(in);
        break;
      case CONSTANT_METHOD_HANDLE:
        cp = new ConstantMethodHandleInfo(in);
        break;
      case CONSTANT_METHOD_TYPE:
        cp = new ConstantMethodTypeInfo(in);
        break;
      case CONSTANT_DYNAMIC:
        cp = new ConstantDynamicInfo(in);
        break;
      case CONSTANT_INVOKE_DYNAMIC:
        cp = new ConstantInvokeDynamicInfo(in);
        break;
      case CONSTANT_MODULE:
        cp = new ConstantModuleInfo(in);
        break;
      case CONSTANT_PACKAGE:
        cp = new ConstantPackageInfo(in);
        break;
      default:
